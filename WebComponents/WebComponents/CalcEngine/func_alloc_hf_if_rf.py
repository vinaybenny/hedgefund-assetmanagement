...
Function:  func_alloc_hf_if_rf()

Description: This function defines the allocation of wealth between hedge fund,
...
def func_alloc_hf_if_rf( coeffs, simparamObj, sign = -1.0  ):
        
        index_coeff = coeffs[0]         # Amount of initial wealth invested in index fund
        hedge_coeff = coeffs[1]         # Amount of initial wealth invested in hedge fund
        riskfree_coeff = simparamObj.initWealth - index_coeff - hedge_coeff #Remaining wealth is in the risk-free holdings
